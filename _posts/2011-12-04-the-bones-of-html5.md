...
BTW, I recommend you read my short article on [HTML5 Semantics and Good Coding Practices](http://www.aniketpant.com/posts/html5-semantics-and-good-coding-practices).

## What is Bones?

[Bones](http://themble.com/bones/) is a WordPress theme framework developed by [Eddie Machado](http://themble.com/). Twist it and turn it the way you want. Highly flexible it is!
...
1.  [A WordPress framework](https://github.com/eddiemachado/bones)
2.  [A responsive version of the framework](https://github.com/eddiemachado/bones-responsive)
3.  [HTML version](https://github.com/eddiemachado/bones-html)
...
New attributes like itemscope and itemprop have been implemented in the latest update of Bones. These are from the current working draft of [microdata](http://www.w3.org/TR/html5/microdata.html).
...
<article id="post-<?php the_ID(); ?>" php="" post_class="" clearfix="">role="article" itemscope itemtype="http://schema.org/BlogPosting">
  <header>
    ...
    <!-- end article section -->
    <footer><?php the_tags('<br>Tags: ', ', ', ' '); ?></footer>
      <!-- end article footer --></article>
      <!-- end article -->
```
...
Code from [css-tricks.com](http://css-tricks.com/snippets/wordpress/remove-paragraph-tags-from-around-images/)
Your text:
...
So many features packed together into a small theme which can be extended as much as possible. Truly a development framework made for developers. You can see the repository on GitHub over [here](https://github.com/eddiemachado/bones).

If you liked the post, please upvote on HN. Here's the link to the [discussion](http://news.ycombinator.com/item?id=3315583).
